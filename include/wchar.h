...
#ifdef __COREDLL__
__CRT_INLINE wint_t __cdecl __MINGW_NOTHROW	getwc(FILE* f) { return fgetwc(f); }
__CRT_INLINE wint_t __cdecl __MINGW_NOTHROW	putwc(wint_t c, FILE* f) { return fputwc(c, f); }
#endif
