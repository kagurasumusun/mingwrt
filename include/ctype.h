...
#ifdef __DECLSPEC_SUPPORTED
# if (defined (__MSVCRT__) && __MSVCRT_VERSION__ <= 0x0700) || defined (__CRTDLL__)
...
#else		/*  __DECLSPEC_SUPPORTED */
# if defined (__MSVCRT__) && __MSVCRT_VERSION__ <= 0x0700
...
#ifdef __COREDLL__
__CRT_INLINE int __cdecl __MINGW_NOTHROW isleadbyte(int c) {return IsDBCSLeadByte(c); }
#elif !defined(__CEGCC__)
